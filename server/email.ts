...
export async function sendTestEmail(recipientEmail: string): Promise<boolean> {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: 'CuisineMuse <no-reply@resend.dev>',
      to: [recipientEmail],
      subject: 'Welcome to CuisineMuse 🍳 Your AI-Powered Kitchen Companion',
      html: `
        <div style="font-family: sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto;">
          ...
          <ul>
            <li>🍝 Personalized recipes based on your ingredients and preferences</li>
            <li>⏱️ Quick meals tailored to your schedule</li>
            <li>🌍 Global flavors made simple and approachable</li>
          </ul>
